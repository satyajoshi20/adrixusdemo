...
//
//import com.adrixus.demo.config.KafkaProperties;
...
//
//class CustomerserviceKafkaResourceIT {
//
...
//
//        CustomerserviceKafkaResource kafkaResource = new CustomerserviceKafkaResource(kafkaProperties);
//
...
//        restMockMvc.perform(post("/api/customerservice-kafka/publish/topic-produce?message=value-produce"))
...
//
//        MvcResult mvcResult = restMockMvc.perform(get("/api/customerservice-kafka/consume?topic=topic-consume"))
//            .andExpect(status().isOk())
