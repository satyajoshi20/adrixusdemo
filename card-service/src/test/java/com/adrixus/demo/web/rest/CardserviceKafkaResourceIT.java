...
//
//class CardserviceKafkaResourceIT {
//
...
//
//        CardserviceKafkaResource kafkaResource = new CardserviceKafkaResource(kafkaProperties);
//
...
//        restMockMvc.perform(post("/api/cardservice-kafka/publish/topic-produce?message=value-produce"))
...
//
//        MvcResult mvcResult = restMockMvc.perform(get("/api/cardservice-kafka/consume?topic=topic-consume"))
//            .andExpect(status().isOk())
