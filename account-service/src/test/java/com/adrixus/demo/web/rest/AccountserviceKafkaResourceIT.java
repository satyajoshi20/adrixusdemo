...
//
//class AccountserviceKafkaResourceIT {
//
...
//
//        AccountserviceKafkaResource kafkaResource = new AccountserviceKafkaResource(kafkaProperties);
//
...
//        restMockMvc.perform(post("/api/accountservice-kafka/publish/topic-produce?message=value-produce"))
...
//
//        MvcResult mvcResult = restMockMvc.perform(get("/api/accountservice-kafka/consume?topic=topic-consume"))
//            .andExpect(status().isOk())
